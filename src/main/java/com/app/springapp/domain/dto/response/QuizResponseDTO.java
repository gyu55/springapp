...
import com.app.springapp.domain.dto.QuizDTO;
import lombok.Data;
...
@Component
@Data
@Schema(description = "분야별 퀴즈 응답 DTO")
public class QuizResponseDTO {
    ...
    public static QuizResponseDTO from(QuizDTO dto) {
        QuizResponseDTO res = new QuizResponseDTO();
        res.setId(dto.getId());
        res.setQuizTitle(dto.getQuizTitle());
        res.setQuizDetail(dto.getQuizDetail());
        res.setQuizCategory(dto.getQuizCategory());
        res.setQuizThumbnail(dto.getQuizThumbnail());
        res.setQuizCreateAt(dto.getQuizCreateAt());
        return res;
    }
}
