...
import com.app.springapp.domain.dto.ReportDTO;
import lombok.Data;
...
@Component
@Data
@Schema(description = "통합 신고 응답 DTO")
public class ReportResponseDTO {
    ...
    public static ReportResponseDTO from(ReportDTO dto) {
        ReportResponseDTO res = new ReportResponseDTO();
        res.setId(dto.getId());
        res.setReportTitle(dto.getReportTitle());
        res.setReportDetail(dto.getReportDetail());
        res.setReportCreateAt(dto.getReportCreateAt());
        res.setReportTypeId(dto.getReportTypeId());
